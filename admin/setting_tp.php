            ...
            <table id="data-tp" class="table table-bordered table-striped">
               ...
               ?>
                  <tr>
                     ...
                     <td><a href="setting_tp_form_edit.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-primary" title="Edit Tahun Pelajaran"><i class="glyphicon glyphicon-edit"></i> Edit</a></td>
                     <td><a href="setting_tp_proses_delete.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-danger" title="Delete  Tahun Pelajaran" onclick="return confirm('Anda yakin ingin menghapus data <?php echo $row['nama']; ?>?');"><i class="glyphicon glyphicon-trash"></i> Delete</a></td>
						</tr>
               <?php } ?>
               </tbody>
            </table>
